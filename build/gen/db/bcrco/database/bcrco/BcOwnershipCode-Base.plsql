...
DB_CUSTOMER_OWNED              CONSTANT VARCHAR2(14) := 'CUSTOMER_OWNED';
DB_COMPANY_OWNED               CONSTANT VARCHAR2(13) := 'COMPANY_OWNED';
...
IS
BEGIN
   RETURN('CUSTOMER_OWNED^COMPANY_OWNED^');
...
IS
BEGIN
   RETURN('Customer Owned^Company Owned^');
...
IS
BEGIN
   RETURN('CustomerOwned^CompanyOwned^');
