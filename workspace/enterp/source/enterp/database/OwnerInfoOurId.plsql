...
--  ------  ------  ---------------------------------------------------------
--  990125  Camk    Created.
--  091203  Kanslk  Reverse-Engineering, changed comapny to a parent key
...
PROCEDURE Check_Common___ (
   oldrec_ IN     owner_info_our_id_tab%ROWTYPE,
   newrec_ IN OUT owner_info_our_id_tab%ROWTYPE,
