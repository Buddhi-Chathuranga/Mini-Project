...
--  ------  ------  ---------------------------------------------------------
--  990125  Camk    Created.
--  091203  Kanslk  Reverse-Engineering, changed company to parent key.
--  131108  Isuklk  PBFI-3347 Refactoring in CustomsInfoOurId.entity
...
PROCEDURE Check_Common___ (
   oldrec_ IN     customs_info_our_id_tab%ROWTYPE,
   newrec_ IN OUT customs_info_our_id_tab%ROWTYPE,
