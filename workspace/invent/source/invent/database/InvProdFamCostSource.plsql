-----------------------------------------------------------------------------
--
--  Logical unit: InvProdFamCostSource
--  Component:    INVENT
--
...
IS
   temp_ INV_PROD_FAM_COST_SOURCE_TAB.cost_source_id%TYPE;
   CURSOR get_attr IS
      SELECT cost_source_id
      FROM   INV_PROD_FAM_COST_SOURCE_TAB
      WHERE  company = company_
      AND   part_product_family = part_product_family_
