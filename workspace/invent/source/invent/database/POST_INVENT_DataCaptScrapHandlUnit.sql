-----------------------------------------------------------------------------
--
--  Filename      : POST_INVENT_DataCaptScrapHandlUnit.sql
--
--  Module        : INVENT
--
--  Purpose       : Inserting data into DataCaptureProcess and
--                  DataCaptureConfig tables for process SCRAP_HANDLING_UNIT.
--
...
--  171101  DaZase  STRSC-13067, Added GS1_BARCODE1, GS1_BARCODE2 as new data items.
...
SET SERVEROUTPUT ON
exec Database_SYS.Log_Detail_Time_Stamp('INVENT','POST_INVENT_DataCaptScrapHandlUnit.sql','Timestamp_1');
PROMPT Starting POST_INVENT_DataCaptScrapHandlUnit.SQL

-----------------------------------------------------------------------------
--    Add Basic Data for DataCaptureProcess and child tables
-----------------------------------------------------------------------------

exec Database_SYS.Log_Detail_Time_Stamp('INVENT','POST_INVENT_DataCaptScrapHandlUnit.sql','Timestamp_2');
PROMPT Inserting SCRAP_HANDLING_UNIT process to DataCaptureProcess and DataCaptureConfig
-- Add New Process
BEGIN
   Data_Capture_Common_Util_API.Install_Process_And_All_Config(capture_process_id_ => 'SCRAP_HANDLING_UNIT',
                                                               description_        => 'Scrap Handling Unit',
                                                               process_package_    => 'DATA_CAPT_SCRAP_HANDL_UNIT_API',
                                                               process_component_  => 'INVENT',
                                                               config_menu_label_  => 'Scrap Handling Unit');
END;
/

exec Database_SYS.Log_Detail_Time_Stamp('INVENT','POST_INVENT_DataCaptScrapHandlUnit.sql','Timestamp_3');
PROMPT Inserting SCRAP_HANDLING_UNIT process DATA_CAPT_PROC_DATA_ITEM_TAB and DATA_CAPT_CONF_DATA_ITEM_TAB
-- Add New Process and Configuration Data Items
DECLARE
   config_data_item_order_ NUMBER := 1;
BEGIN
   Data_Capture_Common_Util_API.Install_Data_Item_All_Configs(capture_process_id_            => 'SCRAP_HANDLING_UNIT',
...
exec Database_SYS.Log_Detail_Time_Stamp('INVENT','POST_INVENT_DataCaptScrapHandlUnit.sql','Timestamp_4');
PROMPT Inserting SCRAP_HANDLING_UNIT process to DATA_CAPT_PROC_FEEDBA_ITEM
-- Add New Process Feedback Items
BEGIN
   Data_Capture_Common_Util_API.Install_Process_Feedback_Item(capture_process_id_  => 'SCRAP_HANDLING_UNIT',
                                                              feedback_item_id_    => 'HANDLING_UNIT_STRUCTURE_LEVEL',
                                                              description_         => 'Structure Level',
                                                              data_type_           => 'NUMBER');

   Data_Capture_Common_Util_API.Install_Process_Feedback_Item(capture_process_id_  => 'SCRAP_HANDLING_UNIT',
                                                              feedback_item_id_    => 'SCRAPPING_CAUSE_DESC',
                                                              description_         => 'Scrapping Cause Desc',
                                                              data_type_           => 'STRING');
...
exec Database_SYS.Log_Detail_Time_Stamp('INVENT','POST_INVENT_DataCaptScrapHandlUnit.sql','Timestamp_5');
PROMPT Inserting SCRAP_HANDLING_UNIT process to DATA_CAPTURE_PROCES_DETAIL
-- Add New Process/Configuration Details
BEGIN

   Data_Capture_Common_Util_API.Install_Detail_All_Configs(capture_process_id_        => 'SCRAP_HANDLING_UNIT',
...
exec Database_SYS.Log_Detail_Time_Stamp('INVENT','POST_INVENT_DataCaptScrapHandlUnit.sql','Done');
PROMPT Finished with POST_INVENT_DataCaptScrapHandlUnit.sql
