-----------------------------------------------------------------------------
--
--  Logical unit: AccGroupCostSource
--  Component:    INVENT
--
...
IS
   temp_ ACC_GROUP_COST_SOURCE_TAB.cost_source_id%TYPE;
   CURSOR get_attr IS
      SELECT cost_source_id
      FROM ACC_GROUP_COST_SOURCE_TAB
      WHERE company = company_
      AND   accounting_group = accounting_group_
