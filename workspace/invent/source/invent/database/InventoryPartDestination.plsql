...
--  170516  DaZase  STRSC-7886, Added Data_Capt_Item_Value_Exist and Get_Data_Capt_Item_Value_Desc so Destination can be properbly used a subsequent control value in wadaco.
...
-- This method is used by DataCaptureInventUtil
@ServerOnlyAccess
