...
-------------------------------------------------------------------------------
--
--  Filename      : POST_Invent_DataCaptChangeParentHu.sql
--
--  Module        : INVENT
--
...
--  171207  MaAuse  STRSC-15087, Added MAX_WEIGHT_VOLUME_ERROR as a new detail item.
--  171017  DaZase  STRSC-13001, Added GS1_BARCODE1, GS1_BARCODE2 as a new data items.
...
SET SERVEROUTPUT ON
exec Database_SYS.Log_Detail_Time_Stamp('INVENT','POST_Invent_DataCaptChangeParentHu.sql','Timestamp_1');
PROMPT Starting POST_Invent_DataCaptChangeParentHu.sql

-----------------------------------------------------------------------------
--    Add Basic Data for DataCaptureProcess and child tables
-----------------------------------------------------------------------------

exec Database_SYS.Log_Detail_Time_Stamp('INVENT','POST_Invent_DataCaptChangeParentHu.sql','Timestamp_2');
PROMPT Inserting CHANGE_PARENT_HANDLING_UNIT process to DataCaptureProcess and DataCaptureConfig
-- Add New Process
BEGIN
   Data_Capture_Common_Util_API.Install_Process_And_All_Config(capture_process_id_ => 'CHANGE_PARENT_HANDLING_UNIT',
                                                               description_        => 'Change Parent Handling Unit',
                                                               process_package_    => 'DATA_CAPT_CHANGE_PARENT_HU_API',
                                                               process_component_  => 'INVENT',
                                                               config_menu_label_  => 'Change Parent Handling Unit');
END;
/

exec Database_SYS.Log_Detail_Time_Stamp('INVENT','POST_Invent_DataCaptChangeParentHu.sql','Timestamp_3');
...
DECLARE
   config_data_item_order_ NUMBER := 5;  -- Leaving a space of 4 for shipment data items that might be installed into this process
BEGIN
   ...
   Data_Capture_Common_Util_API.Install_Data_Item_All_Configs(capture_process_id_            => 'CHANGE_PARENT_HANDLING_UNIT',
                                                              data_item_id_                  => 'NEW_PARENT_HANDLING_UNIT_ID',
                                                              description_                   => 'New Parent Handling Unit ID',
                                                              data_type_db_                  => 'NUMBER',
                                                              process_key_db_                => 'TRUE',
                                                              config_list_of_values_db_      => 'ON',
                                                              config_use_automatic_value_db_ => 'OFF',
   ...
   Data_Capture_Common_Util_API.Install_Data_Item_All_Configs(capture_process_id_            => 'CHANGE_PARENT_HANDLING_UNIT',
                                                              data_item_id_                  => 'NEW_PARENT_SSCC',
                                                              description_                   => 'New Parent SSCC',
                                                              data_type_db_                  => 'STRING',
                                                              string_length_                 => 18,
                                                              process_key_db_                => 'FALSE',
                                                              config_hide_line_db_           => 'ALWAYS',
   ...
   Data_Capture_Common_Util_API.Install_Data_Item_All_Configs(capture_process_id_            => 'CHANGE_PARENT_HANDLING_UNIT',
                                                              data_item_id_                  => 'NEW_PARENT_ALT_HANDLING_UNIT_LABEL_ID',
                                                              description_                   => 'New Parent Alt Handling Unit Label ID',
                                                              data_type_db_                  => 'STRING',
                                                              uppercase_db_                  => 'FALSE',
                                                              string_length_                 => 25,
                                                              process_key_db_                => 'FALSE',
...
exec Database_SYS.Log_Detail_Time_Stamp('INVENT','POST_Invent_DataCaptChangeParentHu.sql','Timestamp_4');
...
BEGIN
   ...
   Data_Capture_Common_Util_API.Install_Process_Feedback_Item(capture_process_id_ => 'CHANGE_PARENT_HANDLING_UNIT',
                                                              feedback_item_id_   => 'OLD_PARENT_HANDLING_UNIT_ID',
                                                              description_        => 'Old Parent Handling Unit ID',
                                                              data_type_          => 'NUMBER');

   Data_Capture_Common_Util_API.Install_Process_Feedback_Item(capture_process_id_  => 'CHANGE_PARENT_HANDLING_UNIT',
                                                              feedback_item_id_    => 'OLD_PARENT_SSCC',
                                                              description_         => 'Old Parent SSCC',
                                                              data_type_           => 'STRING');

   Data_Capture_Common_Util_API.Install_Process_Feedback_Item(capture_process_id_  => 'CHANGE_PARENT_HANDLING_UNIT',
                                                              feedback_item_id_    => 'OLD_PARENT_ALT_HANDLING_UNIT_LABEL_ID',
                                                              description_         => 'Old Parent Alt Handling Unit Label ID',
                                                              data_type_           => 'STRING');
   ...
   Data_Capture_Common_Util_API.Install_Process_Feedback_Item(capture_process_id_ => 'CHANGE_PARENT_HANDLING_UNIT',
                                                              feedback_item_id_   => 'NEW_PARENT_HANDLING_UNIT_DESC',
                                                              description_        => 'New Parent Handling Unit Description',
                                                              data_type_          => 'STRING');

   Data_Capture_Common_Util_API.Install_Process_Feedback_Item(capture_process_id_ => 'CHANGE_PARENT_HANDLING_UNIT',
                                                              feedback_item_id_   => 'OLD_PARENT_HANDLING_UNIT_DESC',
                                                              description_        => 'Old Parent Handling Unit Description',
                                                              data_type_          => 'STRING');
...
exec Database_SYS.Log_Detail_Time_Stamp('INVENT','POST_Invent_DataCaptChangeParentHu.sql','Timestamp_5');
PROMPT Inserting CHANGE_PARENT_HANDLING_UNIT process to DATA_CAPTURE_PROCES_DETAIL
-- Add New Process/Configuration Details
BEGIN   
   Data_Capture_Common_Util_API.Install_Detail_All_Configs(capture_process_id_        => 'CHANGE_PARENT_HANDLING_UNIT',
...
exec Database_SYS.Log_Detail_Time_Stamp('INVENT','POST_Invent_DataCaptChangeParentHu.sql','Done');
PROMPT Finished with POST_Invent_DataCaptChangeParentHu.sql
