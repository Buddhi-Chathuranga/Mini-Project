-----------------------------------------------------------------------------
--
--  Filename      : POST_Invent_DataCapRecHuFromTrans.sql
--
--  Module        : INVENT
--
--  Purpose       : Inserting data into DataCaptureProcess and
--                  DataCaptureConfig tables for process RECEIVE_HU_FROM_TRANSIT.
--
...
--  171030  DaZase  STRSC-13047, Added GS1_BARCODE1, GS1_BARCODE2 as new data items.
...
SET SERVEROUTPUT ON
exec Database_SYS.Log_Detail_Time_Stamp('INVENT','POST_Invent_DataCapRecHuFromTrans.sql','Timestamp_1');
PROMPT Starting POST_Invent_DataCapRecHuFromTrans.SQL

-----------------------------------------------------------------------------
--    Add Basic Data for DataCaptureProcess and child tables
-----------------------------------------------------------------------------

exec Database_SYS.Log_Detail_Time_Stamp('INVENT','POST_Invent_DataCapRecHuFromTrans.sql','Timestamp_2');
PROMPT Inserting RECEIVE_HU_FROM_TRANSIT process to DataCaptureProcess and DataCaptureConfig
-- Add New Process
BEGIN
   Data_Capture_Common_Util_API.Install_Process_And_All_Config(capture_process_id_ => 'RECEIVE_HU_FROM_TRANSIT',
                                                               description_        => 'Receive Handling Unit from Transit',
                                                               process_package_    => 'DATA_CAP_REC_Hu_From_Trans_API',
                                                               process_component_  => 'INVENT',
                                                               config_menu_label_  => 'Receive Handling Unit from Transit');
END;
/

exec Database_SYS.Log_Detail_Time_Stamp('INVENT','POST_Invent_DataCapRecHuFromTrans.sql','Timestamp_3');
PROMPT Inserting RECEIVE_HU_FROM_TRANSIT process DATA_CAPT_PROC_DATA_ITEM_TAB and DATA_CAPT_CONF_DATA_ITEM_TAB
-- Add New Process and Configuration Data Items
DECLARE
   config_data_item_order_ NUMBER := 1;
BEGIN
   Data_Capture_Common_Util_API.Install_Data_Item_All_Configs(capture_process_id_            => 'RECEIVE_HU_FROM_TRANSIT',
...
exec Database_SYS.Log_Detail_Time_Stamp('INVENT','POST_Invent_DataCapRecHuFromTrans.sql','Timestamp_4');
PROMPT Inserting RECEIVE_HU_FROM_TRANSIT process to DATA_CAPT_PROC_FEEDBA_ITEM
-- Add New Process Feedback Items
BEGIN
   Data_Capture_Common_Util_API.Install_Process_Feedback_Item(capture_process_id_  => 'RECEIVE_HU_FROM_TRANSIT',
...
END;
/
exec Database_SYS.Log_Detail_Time_Stamp('INVENT','POST_Invent_DataCapRecHuFromTrans.sql','Timestamp_5');
PROMPT Inserting RECEIVE_HU_FROM_TRANSIT process to DATA_CAPTURE_PROCES_DETAIL
-- Add New Process/Configuration Details
BEGIN
   Data_Capture_Common_Util_API.Install_Detail_All_Configs(capture_process_id_        => 'RECEIVE_HU_FROM_TRANSIT',
...
exec Database_SYS.Log_Detail_Time_Stamp('INVENT','POST_Invent_DataCapRecHuFromTrans.sql','Done');
PROMPT Finished with POST_Invent_DataCapRecHuFromTrans.sql
