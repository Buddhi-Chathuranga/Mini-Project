...
-----------------------------------------------------------------------------
--
--  Filename      : POST_Invent_DataCaptUnattachPartHu.sql
--
--  Module        : INVENT
--
--  Purpose       : Inserting data into DataCaptureProcess and
--                  DataCaptureConfig tables for process UNATTACH_PART_FROM_HANDL_UNIT.
--
...
--  171103  DaZase  STRSC-13079, Added GS1_BARCODE1, GS1_BARCODE2 and GS1_BARCODE3 as new data items.
--  171008  SURBLK  STRSC-11290, Added GTIN_NO, INPUT_UOM and INPUT_QUANTITY data items and INPUT_CONV_FACTOR as feedback item and GTIN_NO_IS_MANDATORY as detail item.
...
SET SERVEROUTPUT ON
exec Database_SYS.Log_Detail_Time_Stamp('INVENT','POST_Invent_DataCaptUnattachPartHu.sql','Timestamp_1');
PROMPT Starting POST_Invent_DataCaptUnattachPartHu.sql

-----------------------------------------------------------------------------
--    Add Basic Data for DataCaptureProcess and child tables
-----------------------------------------------------------------------------

exec Database_SYS.Log_Detail_Time_Stamp('INVENT','POST_Invent_DataCaptUnattachPartHu.sql','Timestamp_2');
PROMPT Inserting UNATTACH_PART_FROM_HANDL_UNIT process to DataCaptureProcess and DataCaptureConfig
-- Add New Process
BEGIN
   Data_Capture_Common_Util_API.Install_Process_And_All_Config(capture_process_id_ => 'UNATTACH_PART_FROM_HANDL_UNIT',
                                                               description_        => 'Unattach Part from Handling Unit',
                                                               process_package_    => 'DATA_CAPT_UNATTACH_PART_HU_API',
                                                               process_component_  => 'INVENT',
                                                               config_menu_label_  => 'Unattach Part from Handling Unit');
END;
/

exec Database_SYS.Log_Detail_Time_Stamp('INVENT','POST_Invent_DataCaptUnattachPartHu.sql','Timestamp_3');
PROMPT Inserting UNATTACH_PART_FROM_HANDL_UNIT process DATA_CAPT_PROC_DATA_ITEM_TAB and DATA_CAPT_CONF_DATA_ITEM_TAB
-- Add New Process and Configuration Data Items
DECLARE
   config_data_item_order_ NUMBER := 1;
BEGIN

   Data_Capture_Common_Util_API.Install_Data_Item_All_Configs(capture_process_id_            => 'UNATTACH_PART_FROM_HANDL_UNIT',
...
--- GTIN related ---
   ...
   Data_Capture_Common_Util_API.Install_Data_Item_All_Configs(capture_process_id_            => 'UNATTACH_PART_FROM_HANDL_UNIT',
                                                              ...
                                                              description_                   => 'Quantity to Unattach',
                                                              data_type_db_                  => 'NUMBER',
                                                              process_key_db_                => 'FALSE',
   ...
   Data_Capture_Common_Util_API.Install_Data_Item_All_Configs(capture_process_id_            => 'UNATTACH_PART_FROM_HANDL_UNIT',
                                                              ...
                                                              description_                   => 'Catch Quantity to Unattach',
                                                              data_type_db_                  => 'NUMBER',
                                                              process_key_db_                => 'FALSE',
                                                              config_hide_line_db_           => 'ALWAYS',
                                                              onscreen_keyboard_enabled_db_  => 'ON',
...
exec Database_SYS.Log_Detail_Time_Stamp('INVENT','POST_Invent_DataCaptUnattachPartHu.sql','Timestamp_4');
PROMPT Inserting UNATTACH_PART_FROM_HANDL_UNIT process to DATA_CAPT_PROC_FEEDBA_ITEM
...
BEGIN
   ...
   Data_Capture_Common_Util_API.Install_Process_Feedback_Item(capture_process_id_ => 'UNATTACH_PART_FROM_HANDL_UNIT',
...
exec Database_SYS.Log_Detail_Time_Stamp('INVENT','POST_Invent_DataCaptUnattachPartHu.sql','Timestamp_5');
PROMPT Inserting UNATTACH_PART_FROM_HANDL_UNIT process to DATA_CAPTURE_PROCES_DETAIL
-- Add New Process/Configuration Details
BEGIN
   Data_Capture_Common_Util_API.Install_Detail_All_Configs(capture_process_id_        => 'UNATTACH_PART_FROM_HANDL_UNIT',
...
exec Database_SYS.Log_Detail_Time_Stamp('INVENT','POST_Invent_DataCaptUnattachPartHu.sql','Done');
PROMPT Finished with POST_Invent_DataCaptUnattachPartHu.sql
