...
--  210529  Kagalk  FI21R2-1438, Removed column tax_rate_date_2120 from currency_type_basic_data_tab.
--  210602  Tkavlk  FI21R2-1658, Merge AccrulCL_GET.SQL scripts of GET to 21R2.
--  211021  Uppalk  FI21R2-4524, Removed obsolete column tax_buy_rate_base_2210 from currency_type_basic_data_tab.
--  211216  Rruklk  FI21R2-7258, Removed obsolete column CS_USE_RATIO_2210 from STATUTORY_FEE_TAB.
--------------------------------------------------------------------------------
...
PROMPT Dropping obsolete COLUMNS in currency_type_basic_data_tab table from 21.2.0 release.
DECLARE
   column_     Database_SYS.ColRec;
   table_name_ VARCHAR2(30) := 'CURRENCY_TYPE_BASIC_DATA_TAB';
BEGIN 
   column_ := Database_SYS.Set_Column_Values('TAX_RATE_DATE_2120');
   Database_SYS.Alter_Table_Column(table_name_, 'D', column_, TRUE);
END;
/

PROMPT Dropping obsolete COLUMNS in ext_file_template_dir_tab table from 21.2.0 release.
DECLARE
   column_     Database_SYS.ColRec;
   table_name_ VARCHAR2(30) := 'EXT_FILE_TEMPLATE_DIR_TAB';
BEGIN
   column_ := Database_SYS.Set_Column_Values('FILE_PATH_SERVER_2120');
   Database_SYS.Alter_Table_Column(table_name_, 'D', column_, TRUE);
   column_ := Database_SYS.Set_Column_Values('BACKUP_FILE_PATH_SERVER_2120');
   Database_SYS.Alter_Table_Column(table_name_, 'D', column_, TRUE);
   column_ := Database_SYS.Set_Column_Values('OVERWRITE_FILE_2120');
   Database_SYS.Alter_Table_Column(table_name_, 'D', column_, TRUE);   
END;
/

PROMPT Dropping obsolete COLUMNS in audit_format_tab table from 21.2.0 release.
DECLARE
   column_     Database_SYS.ColRec;
   table_name_ VARCHAR2(30) := 'AUDIT_FORMAT_TAB';
BEGIN 
   column_ := Database_SYS.Set_Column_Values('OUTPUT_FILE_DIR_SERVER_2120');
   Database_SYS.Alter_Table_Column(table_name_, 'D', column_, TRUE);
   column_ := Database_SYS.Set_Column_Values('OUTPUT_FILE_DIR_2120');
   Database_SYS.Alter_Table_Column(table_name_, 'D', column_, TRUE);
END;
/

PROMPT Dropping obsolete COLUMNS in Tax_Code_Texts_Tab table from 21.2.0 release.
DECLARE
   column_     Database_SYS.ColRec;
   table_name_ VARCHAR2(30) := 'TAX_CODE_TEXTS_TAB';
BEGIN 
   column_ := Database_SYS.Set_Column_Values('NATUREOF_OPERATION_2120');
   Database_SYS.Alter_Table_Column(table_name_, 'D', column_, TRUE);
END;
/
...
PROMPT -------------------------------------------------------------
PROMPT Removal of obsolete table/columns in ACCRUL used in GET
PROMPT -------------------------------------------------------------

PROMPT Remoaving obsolete tables from GET release...

BEGIN   
   Database_SYS.Remove_Table('TAX_CODE_STRUCT_910',TRUE); 
   Database_SYS.Remove_Table('TAX_CODE_STRUCT_DET_910',TRUE);  
   Database_SYS.Remove_Table('TAX_CODE_STRUCT_DET_REF_910',TRUE);     
END;
/
...
DECLARE
   ...
   table_name_    VARCHAR2(30) := 'CURRENCY_TYPE_BASIC_DATA_TAB';
BEGIN
   column_ := Database_SYS.Set_Column_Values('RATE_DATE_1000');
   Database_SYS.Alter_Table_Column ( table_name_, 'D', column_, TRUE);
   column_ := Database_SYS.Set_Column_Values('TAX_BUY_RATE_BASE_2210');
   Database_SYS.Alter_Table_Column(table_name_, 'D', column_, TRUE);
END;
/
...
BEGIN
   column_ := Database_SYS.Set_Column_Values('K_36_1000');
   Database_SYS.Alter_Table_Column ( table_name_, 'D', column_, TRUE);
   column_ := Database_SYS.Set_Column_Values('K_37_1000');
   Database_SYS.Alter_Table_Column ( table_name_, 'D', column_, TRUE);
   column_ := Database_SYS.Set_Column_Values('K_47_1000');
   Database_SYS.Alter_Table_Column ( table_name_, 'D', column_, TRUE);
   column_ := Database_SYS.Set_Column_Values('K_48_1000');
   Database_SYS.Alter_Table_Column ( table_name_, 'D', column_, TRUE);
   column_ := Database_SYS.Set_Column_Values('K_49_1000');
   Database_SYS.Alter_Table_Column ( table_name_, 'D', column_, TRUE);
   column_ := Database_SYS.Set_Column_Values('K_50_1000');
   Database_SYS.Alter_Table_Column ( table_name_, 'D', column_, TRUE);
END;
/

PROMPT Dropping Temporary COLUMN from VOUCHER_ROW_TAB
DECLARE
   table_name_ VARCHAR2(30) := 'VOUCHER_ROW_TAB';
   column_     Database_SYS.ColRec;
BEGIN
   column_ := Database_SYS.Set_Column_Values('DOCUMENT_NUMBER_TMP');
   Database_SYS.Alter_Table_Column ( table_name_ , 'D', column_ , TRUE );
END;
/

PROMPT Dropping Temporary COLUMN from JPK_FILE_LOG_TAB
DECLARE
   table_name_ VARCHAR2(30) := 'JPK_FILE_LOG_TAB';
   column_     Database_SYS.ColRec;
BEGIN
   column_ := Database_SYS.Set_Column_Values('WARNING_TEXT_1000');
   Database_SYS.Alter_Table_Column ( table_name_ , 'D', column_ , TRUE );
END;
/
...
BEGIN
   column_ := Database_SYS.Set_Column_Values('CS_USE_RATIO_2210');
   Database_SYS.Alter_Table_Column(table_name_, 'D', column_, TRUE);
END;
/
