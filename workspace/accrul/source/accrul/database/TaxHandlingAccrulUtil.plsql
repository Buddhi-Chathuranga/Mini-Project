...
--  210706  PraWlk  FI21R2-925, Passed NULL for cst_code and legal_tax_class when calling Source_Tax_Item_API.Assign_Param_To_Record().
--  210923  PraWlk  FI21R2-4180, Modified Calculate_Tax_Amount___() by passing null for cst_code and legal_tax_class when calling 
...
BEGIN
   Tax_Handling_Util_API.Add_Tax_Code_Info(tax_info_table_, company_, NULL, tax_code_, NULL, NULL, 'FETCH_IF_VALID', tax_percentage_, transaction_date_, NULL, NULL);
