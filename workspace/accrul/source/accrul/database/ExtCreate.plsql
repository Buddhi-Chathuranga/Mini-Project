...
--  221227  Uppalk FIZ-21588, Included auto tax calculation checking logic in procedure Process_Voucher_Rows_By_Item__().
-----------------------------------------------------------------------------
...
--Specification[10/7/98] : Validation Level In Check External Voucher
   ...
   ELSE
      IF load_type_ IS NULL THEN
         auto_tax_calc_ := Ext_Parameters_API.Get_Auto_Tax_Calc_Db(company_,
                                                                   voucher_type_);
      ELSE
         auto_tax_calc_ := Ext_Parameters_API.Get_Auto_Tax_Calc_Db(company_,
                                                                   load_type_);
