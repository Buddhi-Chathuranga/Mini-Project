...
--  220127  Uppalk  Bug 162199, Increased VARCHAR buffer of a variable in Copy_To_Companies_For_Svc method from 2000 to 32000
-----------------------------------------------------------------------------
-----------------------------------------------------------------------------
--  040723  ********************* IMPORTANT *********************************
...
EXCEPTION
   WHEN no_master_company_ THEN
      Error_SYS.Record_General('Account',
                               'NOGROUPCOMPANY: No Master Company Connection Exists for Company :P1',
                               rec_.company);
   WHEN no_group_accnt_ THEN
      Error_SYS.Record_General('Account',
                               'NOGROUPACCOUNT: This group account is not in the companys plan of accounts');   
...
BEGIN
   ...
   IF newrec_.include_in_rev_rec IS NULL THEN
      newrec_.include_in_rev_rec := 'FALSE';
   END IF;
