...
--  Date    Sign    History
--  ------  ------  ---------------------------------------------------------
--  210728  Jadulk  FI21R2-3207, Modified Copy_Into_Voucher__.
--  210803  Alwolk  FI21R2-3469, Removed Exist_Approver_Connection().
--  210817  Jadulk  FI21R2-3207, Modified code in Copy_Into_Voucher__.
-----------------------------------------------------------------------------
...
BEGIN
   ...
   IF is_voucher_approvers_exist%FOUND THEN
      Voucher_Candidate_Approver_API.Remove_All_Voucher_Approvers(company_, accounting_year_, voucher_type_, voucher_no_);
      Voucher_API.Remove_Vou_Approve_Rule__(company_, accounting_year_, voucher_type_, voucher_no_);
   END IF;
