...
--  221005  TiRalk FIZ-20046, Modified New_Transaction to calculate currency_debit_amount and currency_credit_amount properly when currency amount is zero.
-----------------------------------------------------------------------------
...
BEGIN
   ...
   transaction_rec_.third_currency_debit_amount := newrec_.third_currency_debit_amount;
   transaction_rec_.third_currency_credit_amount := newrec_.third_currency_credit_amount;
