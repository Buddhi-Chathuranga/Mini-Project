...
FUNCTION Get_Currency_Converted_Amount(
   ...
   master_company_curr_code_   IN VARCHAR2 DEFAULT NULL,
   round_                      IN VARCHAR2 DEFAULT 'TRUE') RETURN ConvertedAmountsRec
IS
...
BEGIN
   ...
   ELSE
      return_amounts_.conv_credit_amount  := credit_converted_amount_;
      return_amounts_.conv_debit_amount   := dedit_converted_amount_;
   END IF;
