 ...
 * @author rakuse
 *
 * Defines the syntax for SolutionSet configuration. 
 * The class is copied from DevStudio, that will be the master for this class.
 * If any bugs found, please inform DevStudio team.
 *
 */
public class SolutionSetConfig {
