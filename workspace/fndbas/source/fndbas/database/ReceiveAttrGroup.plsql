...
--  Date    Sign    History
--  ------  ------  ---------------------------------------------------------
--  000621  ROOD  Modified length in view comments for some attributes. 
...
PROCEDURE Insert___ (
   ...
   newrec_     IN OUT RECEIVE_ATTR_GROUP_TAB%ROWTYPE,
   attr_       IN OUT VARCHAR2 )
IS
BEGIN
...
PROCEDURE Update___ (
   objid_      IN     VARCHAR2,
   oldrec_     IN     RECEIVE_ATTR_GROUP_TAB%ROWTYPE,
   newrec_     IN OUT RECEIVE_ATTR_GROUP_TAB%ROWTYPE,
   attr_       IN OUT VARCHAR2,
