-----------------------------------------------------------------------------
--
--  Logical unit: ReportLayoutTemplate
--  Component:    FNDBAS
--
...
PROCEDURE Check_Insert___ (
   newrec_ IN OUT REPORT_LAYOUT_TEMPLATE_TAB%ROWTYPE,
...
PROCEDURE Check_Update___ (
   oldrec_ IN     REPORT_LAYOUT_TEMPLATE_TAB%ROWTYPE,
   newrec_ IN OUT REPORT_LAYOUT_TEMPLATE_TAB%ROWTYPE,
   indrec_ IN OUT Indicator_Rec,
   attr_   IN OUT VARCHAR2 )
IS
...
PROCEDURE Write_Data__ (
   ...
   lob_loc_    IN     BLOB )
IS
   newrec_  REPORT_LAYOUT_TEMPLATE_TAB%ROWTYPE;
   oldrec_  REPORT_LAYOUT_TEMPLATE_TAB%ROWTYPE;
...
IS
   ...
   CURSOR find_unique_ IS
      SELECT file_name
      FROM   REPORT_LAYOUT_TEMPLATE_TAB
