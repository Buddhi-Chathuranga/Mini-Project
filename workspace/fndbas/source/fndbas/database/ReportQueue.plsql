...
TYPE Report_Queues IS TABLE OF report_queue_tab%ROWTYPE;
...
PROCEDURE Check_Insert___ (
   newrec_ IN OUT report_queue_tab%ROWTYPE,
...
PROCEDURE Check_Delete___ (
   remrec_ IN report_queue_tab%ROWTYPE )
IS
BEGIN
...
BEGIN
   ...
   Report_Runtime_API.Sync_Queue_(newrec_);
END Insert___;
...
PROCEDURE Update___ (
   objid_      IN     VARCHAR2,
   oldrec_     IN     report_queue_tab%ROWTYPE,
   newrec_     IN OUT report_queue_tab%ROWTYPE,
   attr_       IN OUT VARCHAR2,
...
BEGIN
   ...
   Report_Runtime_API.Remove_Queue_(remrec_.instance_name);
END Delete___;
