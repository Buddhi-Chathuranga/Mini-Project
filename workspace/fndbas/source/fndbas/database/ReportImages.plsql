...
BEGIN
   ...
   IF (NOT Report_Images_API.Exists(report_id_,image_name_)) THEN
      ...
      ret_value_ := 'IMPORT';
   ELSE
      IF (UPPER(Get_Prevent_Overwrite(report_id_, image_name_)) = 'FALSE') THEN
         Get_Id_Version_By_Keys___ (objid_,objversion_,report_id_,image_name_);
         Client_SYS.Add_To_Attr('MODULE',module_,attr_);
         Client_SYS.Add_To_Attr('PREVENT_OVERWRITE',prevent_overwrite_,attr_);
