-----------------------------------------------------------------------------
--
--  Logical unit: ConnectPrintAgentTask
--  Component:    FNDBAS
--
...
--  Date        Sign    History
--  ----------  ------  -----------------------------------------------------
--  2019-11-18  japase  PACZDATA-1789: Created
-----------------------------------------------------------------------------
...
TYPE Connect_Print_Agent_Tasks IS TABLE OF connect_print_agent_task_tab%ROWTYPE;
...
PROCEDURE Check_Common___ (
   oldrec_ IN     connect_print_agent_task_tab%ROWTYPE,
   newrec_ IN OUT connect_print_agent_task_tab%ROWTYPE,
   indrec_ IN OUT Indicator_Rec,
   attr_   IN OUT VARCHAR2 ) IS
BEGIN
   super(oldrec_, newrec_, indrec_, attr_);
   Connect_Config_API.Encrypt_(newrec_.debug_password, indrec_.debug_password);
END Check_Common___;
...
BEGIN
   ...
   Connect_Runtime_API.Sync_Print_Agent_Task_(newrec_);
END Insert___;
...
PROCEDURE Delete___ (
   objid_  IN VARCHAR2,
   remrec_ IN connect_print_agent_task_tab%ROWTYPE )
IS
BEGIN
   super(objid_, remrec_);
   Connect_Runtime_API.Remove_Print_Agent_Task_(remrec_.instance_name);
END Delete___;
...
PROCEDURE To_Runtime_Params_ (
   ...
   tasks_  IN     Connect_Print_Agent_Tasks) IS
BEGIN
