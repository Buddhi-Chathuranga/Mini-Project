-----------------------------------------------------------------------------
--
--  Logical unit: FndProjEntActionUsage
--  Component:    FNDBAS
--
...
IS
   rec_ fnd_proj_ent_action_usage_tab%ROWTYPE;
BEGIN
   ...
   IF Check_Exist___(projection_name_,entity_name_, action_name_, client_,artifact_name_) THEN
