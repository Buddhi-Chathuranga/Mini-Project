-----------------------------------------------------------------------------
--
--  Logical unit: SupWarrantyTempCond
--  Component:    MPCCOM
--
...
--  Date    Sign    History
--  ------  ------  ---------------------------------------------------------
--  100520  MoNilk  Modified key flag to P in SUP_WARRANTY_TEMP_COND.condition_id.
--  ------------------------ 14.0.0 -----------------------------------------
...
PROCEDURE Validate_Min_Max_Values___(
   rec_ IN SUP_WARRANTY_TEMP_COND_TAB%ROWTYPE )
IS
...
PROCEDURE Check_Insert___ (
   newrec_ IN OUT sup_warranty_temp_cond_tab%ROWTYPE,
...
PROCEDURE Check_Update___ (
   oldrec_ IN     sup_warranty_temp_cond_tab%ROWTYPE,
   newrec_ IN OUT sup_warranty_temp_cond_tab%ROWTYPE,
   indrec_ IN OUT Indicator_Rec,
   attr_   IN OUT VARCHAR2 )
IS 
