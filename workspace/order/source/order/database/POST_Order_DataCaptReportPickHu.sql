-------------------------------------------------------------------------------
--
--  Filename      : POST_Order_DataCaptReportPickHu.sql
--
--  Module        : ORDER
--
--  Purpose       : Inserting data into DataCaptureProcess and
--                  DataCaptureConfig tables for process REPORT_PICKING_HU.
--
...
--  Date    Sign    History
--  ------  ------  -----------------------------------------------------------
--  201215  Dazase  Bug 157109 (SCZ-12924), Added PICK_BY_CHOICE_DETAILS as a new process detail flag.
...
--  170918  DaZase  STRSC-11606, Added GS1_BARCODE1, GS1_BARCODE2 and GS1_BARCODE3 as a new data items.
--  170522  RuLiLk  Bug 131948, Set config_use_automatic_value_db_ 'OFF' in UNIQUE_LINE_ID to fetch values using only LOV AUTO_PICK to avoid duplicate record set error.
--  170227  KhVese  LIM-5836, Changed config_use_automatic_value_db_ for data item LOCATIN_NO to be FIXED.
--  170131  DaZase  Created.
------------------------------------------------------------------------------

SET SERVEROUTPUT ON
exec Database_SYS.Log_Detail_Time_Stamp('ORDER','POST_Order_DataCaptReportPickHu.sql','Timestamp_1');
PROMPT Starting POST_Order_DataCaptReportPickHu.SQL
...
exec Database_SYS.Log_Detail_Time_Stamp('ORDER','POST_Order_DataCaptReportPickHu.sql','Timestamp_2');
PROMPT Inserting REPORT_PICKING_HU process to DataCaptureProcess and DataCaptureConfig
-- Add New Process
BEGIN
   Data_Capture_Common_Util_API.Install_Process_And_All_Config(capture_process_id_ => 'REPORT_PICKING_HU',
                                                               description_        => 'Report Picking of Handling Units',
                                                               process_package_    => 'DATA_CAPT_REPORT_PICK_HU_API',
                                                               process_component_  => 'ORDER',
                                                               config_menu_label_  => 'Report Picking of Handling Units');
END;
/


exec Database_SYS.Log_Detail_Time_Stamp('ORDER','POST_Order_DataCaptReportPickHu.sql','Timestamp_3');
PROMPT Inserting REPORT_PICKING_HU process to DATA_CAPT_PROC_DATA_ITEM_TAB and DATA_CAPT_CONF_DATA_ITEM_TAB
-- Add New Process and Configuration Data Items
DECLARE
   config_data_item_order_ NUMBER := 1;
BEGIN
   Data_Capture_Common_Util_API.Install_Data_Item_All_Configs(capture_process_id_            => 'REPORT_PICKING_HU',
...
exec Database_SYS.Log_Detail_Time_Stamp('ORDER','POST_Order_DataCaptReportPickHu.sql','Timestamp_4');
PROMPT Inserting REPORT_PICKING_HU process to DATA_CAPT_PROC_FEEDBA_ITEM
...
BEGIN
   ...
   Data_Capture_Common_Util_API.Install_Process_Feedback_Item(capture_process_id_ => 'REPORT_PICKING_HU',
...
exec Database_SYS.Log_Detail_Time_Stamp('ORDER','POST_Order_DataCaptReportPickHu.sql','Timestamp_5');
PROMPT ADD CONFIG CTRL ITEM TO REPORT_PICKING_HU process
BEGIN
   Data_Capture_Common_Util_API.Install_Config_Ctrl_Item(capture_process_id_           => 'REPORT_PICKING_HU',
...
exec Database_SYS.Log_Detail_Time_Stamp('ORDER','POST_Order_DataCaptReportPickHu.sql','Timestamp_6');
PROMPT Inserting REPORT_PICKING_HU base configuration to DATA_CAPTURE_PROCES_DETAIL and DATA_CAPTURE_CONFIG_DETAIL
-- Add New Configuration Details
BEGIN

   Data_Capture_Common_Util_API.Install_Detail_All_Configs(capture_process_id_        => 'REPORT_PICKING_HU',
...
exec Database_SYS.Log_Detail_Time_Stamp('ORDER','POST_Order_DataCaptReportPickHu.sql','Timestamp_7');
PROMPT Connecting feedback items to base (config_id =1) REPORT_PICKING_HU process
-- Connect feedback items to data items
BEGIN
   Data_Capture_Common_Util_API.Connect_Detail_To_Data_Item(capture_process_id_  => 'REPORT_PICKING_HU',
                                                            data_item_id_        => 'AGGREGATED_LINE_ID',
...
exec Database_SYS.Log_Detail_Time_Stamp('ORDER','POST_Order_DataCaptReportPickHu.sql','Timestamp_8');
PROMPT Inserting REPORT_PICKING_HU to SUBSEQ_DATA_CAPTURE_CONFIG_TAB
BEGIN

   -- Add START_WAREHOUSE_TASK as subsequent configuration item for process REPORT_PICKING_HU (LAST_LINE_ON_PICK_LIST feedback item is
   -- the Subsequent Control Feedback Item in this case on REPORT_PICKING_HU)
   -- We can install this here because START_WAREHOUSE_TASK is already installed. While 'N' value is installed in script for START_PICKING since START_PICKING is not installed here yet.
   Data_Capture_Common_Util_API.Install_Subseq_Config(capture_process_id_            => 'REPORT_PICKING_HU',
...
exec Database_SYS.Log_Detail_Time_Stamp('ORDER','POST_Order_DataCaptReportPickHu.sql','Done');
PROMPT Finished with POST_Order_DataCaptReportPickHu.SQL
