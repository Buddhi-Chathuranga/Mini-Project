-----------------------------------------------------------------------------
--
--  Logical unit: RebateAgrSpDealFinal
--  Component:    ORDER
--
...
--  Date    Sign    History
--  ------  ------  ---------------------------------------------------------
--  170424  ThImlk  STRMF-10971, Modified Copy_Sales_Part_Deal_Final__() to set min_value and percentage values correctly, when copying rebate agreements.
...
PROCEDURE Check_Delete___ (
   remrec_ IN REBATE_AGR_SP_DEAL_FINAL_TAB%ROWTYPE )
IS
BEGIN
...
-- Copy_Sales_Part_Deal_Final__
--   Copy an existing record details  to a new record.
PROCEDURE Copy_Sales_Part_Deal_Final__ (
...
IS
   CURSOR  get_source_all IS
      SELECT *
      FROM REBATE_AGR_SP_DEAL_FINAL_TAB
   ...
   newrec_        REBATE_AGR_SP_DEAL_FINAL_TAB%ROWTYPE;
   objid_         VARCHAR2(2000);
   objversion_    VARCHAR2(2000);
   to_min_value_  REBATE_AGR_SP_DEAL_FINAL_TAB.min_value%TYPE;
   to_percentage_ REBATE_AGR_SP_DEAL_FINAL_TAB.percentage%TYPE;
...
BEGIN
   ...
   END LOOP;
END Copy_Sales_Part_Deal_Final__;
