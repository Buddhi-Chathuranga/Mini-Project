------------------------------------------------------------------------------
--
--  Filename      : POST_Shpmnt_DataCaRetPartShipInv.sql
--
--  Module        : SHPMNT
--
--  Purpose       : Inserting data into DataCaptureProcess and
--                  DataCaptureConfig tables for process RETURN_PARTS_FROM_SHIP_INV.
--
...
--  171101  DaZase  STRSC-13065, Added GS1_BARCODE1, GS1_BARCODE2 and GS1_BARCODE3 as new data items.
--  171009  DaZase  STRSC-8551, Added GTIN_NO, INPUT_UOM and INPUT_QTY_RETURNED data items and GTIN_DEFAULT/INPUT_CONV_FACTOR as feedback items and GTIN_NO_IS_MANDATORY as detail item.
...
--  151111  Erlise  LIM-4301, Added new feedback items connected to handling unit.
--  150918  DaZase  AFT-5484, Added data_type to all new feedback items.
--  150901  DaZase  AFT-2994, Added BARCODE_ID as a new data item.
--  150706  RILSAE  Created.
-----------------------------------------------------------------------------
SET SERVEROUTPUT ON
exec Database_SYS.Log_Detail_Time_Stamp('SHPMNT','POST_Shpmnt_DataCaRetPartShipInv.sql','Timestamp_1');
PROMPT Starting POST_Shpmnt_DataCaRetPartShipInv.sql

-----------------------------------------------------------------------------
--    Add Basic Data for DataCaptureProcess and child tables
-----------------------------------------------------------------------------

exec Database_SYS.Log_Detail_Time_Stamp('SHPMNT','POST_Shpmnt_DataCaRetPartShipInv.sql','Timestamp_2');
PROMPT Inserting RETURN_PARTS_FROM_SHIP_INV process to DataCaptureProcess and DataCaptureConfig
-- Add New Process
BEGIN
   Data_Capture_Common_Util_API.Install_Process_And_All_Config(capture_process_id_ => 'RETURN_PARTS_FROM_SHIP_INV',
                                                               description_        => 'Return Parts from Shipment Inventory',
                                                               process_package_    => 'DATA_CAP_PROCESS_PART_SHIP_API',
                                                               process_component_  => 'SHPMNT',
                                                               config_menu_label_  => 'Return Parts from Ship Inventory');
END;
/

exec Database_SYS.Log_Detail_Time_Stamp('SHPMNT','POST_Shpmnt_DataCaRetPartShipInv.sql','Timestamp_3');
...
BEGIN
   -- These 5 items were added in Apps9 and renamed in Apps10
   Data_Capture_Common_Util_API.Rename_Data_Item_All_Config(capture_process_id_              => 'RETURN_PARTS_FROM_SHIP_INV',
...
exec Database_SYS.Log_Detail_Time_Stamp('SHPMNT','POST_Shpmnt_DataCaRetPartShipInv.sql','Timestamp_4');
PROMPT Inserting RETURN_PARTS_FROM_SHIP_INV process to DATA_CAPT_PROC_DATA_ITEM_TAB and DATA_CAPT_CONF_DATA_ITEM_TAB
-- Add New Process and Configuration Data Items
DECLARE
   config_data_item_order_ NUMBER := 1;
BEGIN
   Data_Capture_Common_Util_API.Install_Data_Item_All_Configs(capture_process_id_            => 'RETURN_PARTS_FROM_SHIP_INV',
   ...
   Data_Capture_Common_Util_API.Install_Data_Item_All_Configs(capture_process_id_            => 'RETURN_PARTS_FROM_SHIP_INV',
                                                              data_item_id_                  => 'INPUT_QTY_RETURNED',
                                                              description_                   => 'Input Qty to Return',
                                                              data_type_db_                  => 'NUMBER',                                                              
                                                              process_key_db_                => 'FALSE',
                                                              config_hide_line_db_           => 'ALWAYS',
                                                              config_use_automatic_value_db_ => 'FIXED',
   ...
   Data_Capture_Common_Util_API.Install_Data_Item_All_Configs(capture_process_id_            => 'RETURN_PARTS_FROM_SHIP_INV',
                                                              data_item_id_                  => 'QTY_RETURNED',
                                                              description_                   => 'Qty to Return',
                                                              data_type_db_                  => 'NUMBER',
                                                              process_key_db_                => 'FALSE',
   ...
   Data_Capture_Common_Util_API.Install_Data_Item_All_Configs(capture_process_id_            => 'RETURN_PARTS_FROM_SHIP_INV',
                                                              data_item_id_                  => 'CATCH_QTY_RETURNED',
                                                              description_                   => 'Catch Qty to Return',
                                                              data_type_db_                  => 'NUMBER',
                                                              process_key_db_                => 'FALSE',
                                                              config_hide_line_db_           => 'ALWAYS',
                                                              onscreen_keyboard_enabled_db_  => 'ON',
...
exec Database_SYS.Log_Detail_Time_Stamp('SHPMNT','POST_Shpmnt_DataCaRetPartShipInv.sql','Timestamp_5');
PROMPT Inserting RETURN_PARTS_FROM_SHIP_INV process to DATA_CAPT_PROC_FEEDBA_ITEM
-- Add New Process Feedback Items
BEGIN

   Data_Capture_Common_Util_API.Install_Process_Feedback_Item(capture_process_id_ => 'RETURN_PARTS_FROM_SHIP_INV',
...
exec Database_SYS.Log_Detail_Time_Stamp('SHPMNT','POST_Shpmnt_DataCaRetPartShipInv.sql','Timestamp_6');
PROMPT Renaming feedback items
-- Rename Configuration Feedback Items
BEGIN
   -- This feedback was added in Apps9 and renamed in Apps10
   Data_Capture_Common_Util_API.Rename_Feedbac_Item_All_Config(capture_process_id_     => 'RETURN_PARTS_FROM_SHIP_INV',
...
exec Database_SYS.Log_Detail_Time_Stamp('SHPMNT','POST_Shpmnt_DataCaRetPartShipInv.sql','Timestamp_7');
...
BEGIN
   ...
   Data_Capture_Common_Util_API.Uninstall_Feedback_All_Config(capture_process_id_  =>  'RETURN_PARTS_FROM_SHIP_INV',
...
exec Database_SYS.Log_Detail_Time_Stamp('SHPMNT','POST_Shpmnt_DataCaRetPartShipInv.sql','Timestamp_8');
PROMPT Inserting RETURN_PARTS_FROM_SHIP_INV process to DATA_CAPTURE_PROCES_DETAIL
-- Add New Process/Configuration Details
BEGIN
   Data_Capture_Common_Util_API.Install_Detail_All_Configs(capture_process_id_        => 'RETURN_PARTS_FROM_SHIP_INV',
...
exec Database_SYS.Log_Detail_Time_Stamp('SHPMNT','POST_Shpmnt_DataCaRetPartShipInv.sql','Done');
PROMPT Finished with POST_Shpmnt_DataCaRetPartShipInv.sql
