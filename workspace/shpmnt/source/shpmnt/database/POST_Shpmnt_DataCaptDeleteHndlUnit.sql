...
-------------------------------------------------------------------------------
--
--  Filename      : POST_SHPMNT_DataCaptDeleteHndlUnit.sql
--
--  Module        : SHPMNT
--
...
--
--  Basic Data Translations: Note if you add or change any data item here, in the current solution
...
-----------------------------------------------------------------------------
SET SERVEROUTPUT ON
exec Database_SYS.Log_Detail_Time_Stamp('SHPMNT','POST_Shpmnt_DataCaptDeleteHndlUnit.sql','Timestamp_1');
PROMPT Starting POST_SHPMNT_DataCaptDeleteHndlUnit.sql

-----------------------------------------------------------------------------
--    Add Basic Data for DataCaptureProcess and child tables
-----------------------------------------------------------------------------

exec Database_SYS.Log_Detail_Time_Stamp('SHPMNT','POST_Shpmnt_DataCaptDeleteHndlUnit.sql','Timestamp_2');
PROMPT Inserting DELETE_HANDLING_UNIT process shipment specific data items to DATA_CAPT_PROC_DATA_ITEM_TAB and DATA_CAPT_CONF_DATA_ITEM_TAB
...
exec Database_SYS.Log_Detail_Time_Stamp('SHPMNT','POST_Shpmnt_DataCaptDeleteHndlUnit.sql','Timestamp_3');
PROMPT Inserting DELETE_HANDLING_UNIT process shipment specific feedback items to DATA_CAPT_PROC_FEEDBA_ITEM
...
exec Database_SYS.Log_Detail_Time_Stamp('SHPMNT','POST_Shpmnt_DataCaptDeleteHndlUnit.sql','Done');
PROMPT Finished with POST_SHPMNT_DataCaptDeleteHndlUnit.sql
