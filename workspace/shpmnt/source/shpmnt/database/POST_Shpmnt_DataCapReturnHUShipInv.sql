...
--  Module : SHPMNT
--
--  File   : POST_Shpmnt_DataCapReturnHUShipInv.sql
--
--  IFS Developer Studio Template Version 2.6
--
--  Purpose       : Inserting data into DataCaptureProcess and
--                  DataCaptureConfig tables for process RETURN_HU_FROM_SHIP_INV .
--
...
--  180202   SWiclk  STRSC-16141, Added TO_XXXX and FROM_XXXX feedback items for WAREHOUSE_ID, BAY_ID, ROW_ID, TIER_ID, BIN_ID and removed general feedbacks.
--  171213   SWiclk  STRSC-15143, Set on-screen keyboard to ON for qty related data items and note/message data items.
--  171208   CKumlk  Renamed file from POST_Shpmnt_DataCapReturnHUShipInv.SQL to POST_Shpmnt_DataCapReturnHUShipInv.sql , renamed process from RETURN_HU_IN_SHIP_INV to 
--                   RETURN_HU_FROM_SHIP_INV and renamed description from Return HU in Shipment Inventory to Move Handling Units Between Shipment Inventories.
...
SET SERVEROUTPUT ON
exec Database_SYS.Log_Detail_Time_Stamp('SHPMNT','POST_Shpmnt_DataCapReturnHUShipInv.sql','Timestamp_1');
PROMPT Starting POST_Shpmnt_DataCapReturnHUShipInv.SQL

-----------------------------------------------------------------------------
--    Add Basic Data for DataCaptureProcess and child tables
-----------------------------------------------------------------------------

exec Database_SYS.Log_Detail_Time_Stamp('SHPMNT','POST_Shpmnt_DataCapReturnHUShipInv.sql','Timestamp_2');
PROMPT Inserting RETURN_HU_FROM_SHIP_INV process to DataCaptureProcess and DataCaptureConfig
-- Add New Process
BEGIN
   Data_Capture_Common_Util_API.Install_Process_And_All_Config(capture_process_id_ => 'RETURN_HU_FROM_SHIP_INV',
                                                               description_        => 'Return Handling Units from Shipment Inventory',
                                                               process_package_    => 'DATA_CAP_PROCESS_HU_SHIP_API',
                                                               process_component_  => 'SHPMNT',
                                                               config_menu_label_  => 'Return HU from Ship Inventory');
END;
/

exec Database_SYS.Log_Detail_Time_Stamp('SHPMNT','POST_Shpmnt_DataCapReturnHUShipInv.sql','Timestamp_3');
PROMPT Inserting RETURN_HU_FROM_SHIP_INV process to DATA_CAPT_PROC_DATA_ITEM_TAB and DATA_CAPT_CONF_DATA_ITEM_TAB
-- Add New Process and Configuration Data Items
DECLARE
   config_data_item_order_ NUMBER := 1;
BEGIN

   Data_Capture_Common_Util_API.Install_Data_Item_All_Configs(capture_process_id_            => 'RETURN_HU_FROM_SHIP_INV',
...
-- Feedback Items -------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------
exec Database_SYS.Log_Detail_Time_Stamp('SHPMNT','POST_Shpmnt_DataCapReturnHUShipInv.sql','Timestamp_4');
PROMPT Inserting MOVE_PART process to DATA_CAPT_PROC_FEEDBA_ITEM
-- Add New Process Feedback Items

BEGIN
   Data_Capture_Common_Util_API.Install_Process_Feedback_Item(capture_process_id_  => 'RETURN_HU_FROM_SHIP_INV',
...
exec Database_SYS.Log_Detail_Time_Stamp('SHPMNT','POST_Shpmnt_DataCapReturnHUShipInv.sql','Timestamp_5');
PROMPT Inserting RETURN_HU_FROM_SHIP_INV process to DATA_CAPTURE_PROCES_DETAIL
-- Add New Process/Configuration Details
BEGIN

   Data_Capture_Common_Util_API.Install_Detail_All_Configs(capture_process_id_        => 'RETURN_HU_FROM_SHIP_INV',
...
exec Database_SYS.Log_Detail_Time_Stamp('SHPMNT','POST_Shpmnt_DataCapReturnHUShipInv.sql','Done');
PROMPT Finished with POST_Shpmnt_DataCapReturnHUShipInv.sql
